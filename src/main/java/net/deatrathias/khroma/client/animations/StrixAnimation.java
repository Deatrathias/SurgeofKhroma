package net.deatrathias.khroma.client.animations;
...
public class StrixAnimation {
	...
	public static final AnimationDefinition FLY = AnimationDefinition.Builder.withLength(2.0F).looping()
			...
			.addAnimation("left_wing", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(2.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -115.0F), AnimationChannel.Interpolations.CATMULLROM)))
	...
	public static final AnimationDefinition HOVER = AnimationDefinition.Builder.withLength(0.5F).looping()
			.addAnimation("left_wing", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(0.25F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -97.5F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition START_GRAB = AnimationDefinition.Builder.withLength(0.1667F)
			.addAnimation("base", new AnimationChannel(AnimationChannel.Targets.ROTATION,
